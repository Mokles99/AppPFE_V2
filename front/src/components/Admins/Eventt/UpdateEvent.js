...
import { UPDATE_EVENT_RESET } from "../../../actions/constantes";
import { useNavigate } from "react-router-dom";

const UpdateEvent = ({ history }) => {
  ...
  }, [dispatch, alert, error, isUpdated, history, event, eventId]);
          ...
          <Fragment>
            <div className="wrapper my-5">
              ...
              >
                ...
                <div className="form-group">
                  <label htmlFor="price_field">Tickets</label>
                  <textarea
                    className="form-control"
                    id="places_field"
                    rows="8"
