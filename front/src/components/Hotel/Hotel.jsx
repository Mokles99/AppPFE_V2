...
import SearchBar from "../../shared/SearchBar2";
import ServicesList from "../Services/ServiceList";
import FeaturedTourList from "../Featured-Tours2/FeaturedTourList";
          ...
          <Row className="numbr1">
            <Col lg="6">
              <div className="hero-content">
                ...
                <p className="debut">
                  "By booking your hotel with OCEANA voyage, you're not just
                  choosing a room. You're choosing the experience, comfort, and
                  peace of mind. Make every stay a story to tell with us."
                </p>
              </div>
            </Col>
          ...
          <Row className="part4">
            <Col lg="6">
              <div className="experience-content">
                ...
                <p>
                Underneath the shining stars lies an unbelievable world of beauty
                  <br />
                  Our promise is to deliver the best,
providing the finest among everything
                </p>
              </div>
              <div className="counter-wrapper d-flex align-items-center gap-5">
                <div className="counter-box">
                  <span>1K+ </span>
                  <h6> Successfull Reservation</h6>
                </div>
                <div className="counter-box">
                  <span>2K+ </span>
